...
import { NgCompatToolTipElement } from './ng-compat-tool-tip';
import { uniqueId } from 'lodash';

export const attributeHelpTextSelector = 'attribute-help-text';

if (!window.customElements.get('ng-compat-tool-tip')) {
  window.NgCompatToolTipElement = NgCompatToolTipElement;
  window.customElements.define('ng-compat-tool-tip', NgCompatToolTipElement);
}
